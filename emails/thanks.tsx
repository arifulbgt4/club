...
const ThanksTemp: React.FC<Readonly<ThanksTemplateProps>> = ({ userName }) => (
  <Html>
    <Head />
    <Preview>Welcome to Otask.</Preview>
    <Tailwind>
        ...
        <Container className="mx-auto my-10 bg-white">
          <Section className="my-8">
            ...
            <Text className="mx-10 text-base">
              Welcome to Otask. Now you can build your idea faster. You can star
              the project on GitHub. That would be very helpful.
            </Text>
            <Section className="my-5 text-center">
              <Button
                className="bg-bg-white inline-block rounded-md bg-slate-900 px-6 py-3 text-base text-white"
                href="https://github.com/ariful/Otask"
                target="_blank"
            ...
            <Text className="mx-10 text-base font-bold">Otask</Text>
          </Section>
        </Container>
      </Body>
    </Tailwind>
